...
<button class="btn btn-primary" ng-click="Modaladd()">+ เพิ่มออฟชั่นใหม่</button>
</div>
...
<input type="text" ng-model="searchtext" class="form-control" placeholder="<?=$lang_search?> ชื่อออฟชั่น" style="width: 350px;" ng-change="getlist(searchtext,'1')">
</div>
...
<br />
*** เช่น ร้อน, เย็น, ปั่น, เพิ่มช็อต, วิปครีม, แก้วเล็ก กลางใหญ่,เส้นเล็ก เส้นใหญ่ ไม่งอก, เผ็ด หวาน สุก ดิบ อื่นๆ<font color="red">(ไม่ตัดสต๊อก)</font>
<br />
...
<table id="headerTable" class="table table-hover table-bordered" style="font-size: 14px;">
	<thead>
		<tr style="background-color: #eee;">
			...
			<th style="text-align: center;width: 100px;">ชื่อออฟชั่น</th>
			<th style="text-align: center;width: 100px;">ราคาที่จะเพิ่มขึ้น</th>
			<th style="text-align: center;width: 100px;">แสดง</th>
...
<img ng-if="x.product_ot_image!=''" ng-src="<?php echo $base_url;?>/{{x.product_ot_image}}" width="70px" height="70px;">
			...
			<td>
				<span ng-if="x.show_all=='0'" style="color:red;">แสดงเฉพาะบางสินค้า</span>
		<span ng-if="x.show_all=='1'">แสดงในทุกสินค้า</span>
			</td>
...
ชื่อออฟชั่น
<input type="text" name="product_ot_name"  placeholder="ชื่อออฟชั่น" class="form-control" required="required">
<p></p>
...
ราคา
	<input type="text" name="product_ot_price"  placeholder="ราคา" class="form-control text-right">
...
ชื่อออฟชั่น
<input type="text" name="product_ot_name" id="product_ot_name" placeholder="ชื่อออฟชั่น" class="form-control" required="required">


	<p></p>
ราคา
	<input type="text" name="product_ot_price" id="product_ot_price" placeholder="ราคา" class="form-control text-right">
