...
*** ตั้งค่าคะแนนแลกอาหาร/เครื่องดื่มฟรี
<br />
<span style="color:red;">*คำแนะนำ ต้องสร้างเมนูอาหาร/เครื่องดื่มใหม่ ใส่ราคาขาย 0 บาท เช่น ไข่เจียว(ฟรี) เพื่อความถูกต้อง*</span>
<br />
<button class="btn btn-primary" ng-click="Openmodalproduct()">+เพิ่มรายการ</button>
<br /><br />
...
<span style="color:red;">*คำแนะนำ ต้องสร้างเมนูอาหาร/เครื่องดื่มใหม่ ใส่ราคาขาย 0 บาท*</span>
<input type="text" placeholder="ค้นหาชื่ออาหาร/เครื่องดื่ม" class="form-control" ng-model="searchproduct" ng-change="Findproduct(searchproduct)">
...
<td><button class="btn btn-success" ng-click="Selectproduct(x)">บันทึก</button></td>
<td>{{x.product_name}}</td>
