...
<nav class="navbar navbar-default" role="navigation" style="color:#fff;background-image: linear-gradient(to bottom,#f0ad4e 0,#f0ad4e 100%);">
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo $base_url; ?>/admin/store_manager" style="color: #000;"><b>C2M</b></a>
		</div>
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			...
			<li>
					<a href="<?php echo $base_url; ?>/admin/store_manager" style="color: #000;"> <b>Administrator</b></a>
				</li>
			</ul>
