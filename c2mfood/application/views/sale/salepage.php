...
<div class="form-group">
<select class="form-control" ng-model="discount_percent" style="font-size: 30px;text-align: right;height: 47px;">
...
<div class="form-group" ng-show="discount_percent=='0'">
<input type="text" class="form-control" ng-model="discount_last" placeholder="ลดจำนวนเงิน" style="font-size: 30px;text-align: right;height: 47px;background-color:#dff0d8;width: 200px;">
<span ng-if="discount_last!='0'" style="font-size: 16px;font-weight: normal;">{{(discount_last*100)/(Sumsaleprice() + (Sumsaleprice() * vatnumber/100)) | number:2 }} %</span>
</div>


<div class="form-group" ng-show="discount_percent=='1'">
<input type="text" class="form-control" ng-model="discount_last_percent" placeholder="ลด %" style="font-size: 30px;text-align: right;height: 47px;background-color:#dff0d8;width: 200px;">
<span ng-if="discount_last_percent!='0'" style="font-size: 16px;font-weight: normal;">{{(Sumsaleprice() + (Sumsaleprice() * vatnumber/100))*(discount_last_percent/100) | number:2 }} <?=$lang_currency?></span>
</div>
...
<form>
		...
		<td align="right" width="10%"><button type="submit" class="btn btn-success btn-lg" id="savesale" ng-click="Savesale(money_from_customer,Sumsalepricevat(),discount_last )"><?=$lang_getmoneyenter?></button>
...
<td align="center" style="width: 100px;">{{ x.product_code }}</td>
			...
			<td style="width: 50px;" align="right">{{(x.product_price - x.product_price_discount) * x.product_sale_num | number:2 }}</td>
			<td><button class="btn btn-danger" ng-click="Deletepush($index)">x</button></td>
		</tr>
