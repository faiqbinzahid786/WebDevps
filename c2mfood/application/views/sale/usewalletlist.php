...
<table id="headerTable" class="table table-hover table-bordered">
	<thead>
		<tr class="trheader">
			...
			<th class="text-center">จำนวนเงินที่ใช้</th>

			<th class="text-center">พนักงานที่ทำรายการ</th>

			<th class="text-center">กะที่</th>
<th class="text-center">บิลเลขที่</th>
...
<td>{{x.cus_name}}</td>
	...
	<td  align="right">{{x.money_use | number}}</td>
