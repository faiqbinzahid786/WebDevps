...
class Printer
{
     ...
     */
     ...
     public function beep($beep, $duration){

//$beep = how many time you want to beep, $duration = how many second.

$this ->getPrintConnector() -> write(PRINTER::ESC . "B" . chr($beep) . chr($duration));
}
