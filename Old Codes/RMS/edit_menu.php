...
echo "<form action='other_editMenu.php' method='post'>
	...
	Dish ID: <input type='text' name='dishId2' class='form-control'> <br>
    Dish Name: <input type='text' name='dishName' class='form-control'> <br>
