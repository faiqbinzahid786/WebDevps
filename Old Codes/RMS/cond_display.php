...
//
echo "<div class='container'><br><h1>Conditional Displaying:</h1>";
echo "<form action='cond_price.php' method='post'>
Price: <select name='price' class='form-control' required=true><option>Please choose an option below</option>";
	...
	echo "</select> <br>
		...
		<button type='submit' class='btn btn-dark form-control'>Display</button>
	</form></div>";
