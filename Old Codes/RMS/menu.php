...
//$sql = "SELECT dishName, ingred, price FROM menu WHERE price > 200 ORDER BY dishId;";
...
<input type='text' name='ssn1' id='ssn1'></form><div class = 'NonPrintable'><br><br></div><h1>Shenanigans Irish Spors Bar</h1><br></div>";
