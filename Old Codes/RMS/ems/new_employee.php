...
echo "<nav class='navbar navbar-expand-sm bg-dark navbar-dark sticky-top'>
        ...
        <ul class='navbar-nav'>
            ...
            <li class='nav-item'>
                <a class='nav-link' href='new_employee.php'>Add Employee</a>
            </li>
            <li>
                <a class='nav-link'>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
echo "<form action='other.php' method='post'>
  First name: <input type='text' name='fname' class='form-control' required=true> <br>
  Surname: <input type='text' name='lname' class='form-control' required=true> <br>
  SSN: <input type='number' min='111111111' max='999999999' name='ssn' class='form-control' required=true> <br>
  Date of b: <input type='text' name='bdate' class='form-control' required=true> <br>
  Salary: <input type='number' min='0' name='salary' class='form-control' required=true> <br>
  Sex: <input type='text' name='sex' class='form-control' required=true> <br>
