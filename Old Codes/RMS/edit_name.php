...
//title of the page 
echo "<head><title>Edit Dish Name</title></head>";
...
echo "<div class='container'><br><h1>Edit existing dish name:</h1>";
echo "<form action='other_editName.php' method='post'>
    ...
    Dish Name: <input type='text' name='dishName' class='form-control'> 
	<br><br>
