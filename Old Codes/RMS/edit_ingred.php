...
//title of the page 
echo "<head><title>Edit Dish Ingredients</title></head>";
...
//
echo "<div class='container'><br><h1>Edit existing dish ingredients:</h1>";
echo "<form action='other_editIngred.php' method='post'>
	...
	echo "</select> 
	<br>
    Ingredients: <input type='text' name='ingred' class='form-control'> 
	<br><br>
