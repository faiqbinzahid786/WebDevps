...
echo "<div class='container-fluidser NonPrintable'>
  <br>
  <h1><strong>Almatloob Gems and Jewelry®</strong></h1> <br>
</div>
...
//Nav Bar or Menu Bar
echo "<nav class='navbar navbar-expand-sm bg-dark navbar-dark sticky-top mine'>
        <div class='container-fluid' id='1'>
        <span class='cover'>
        <ul class='navbar-nav'>
            <li class='nav-item active'>
                <a class='nav-link' href='index.php'>Stock Managment&nbsp &nbsp </a>
            </li>
            <li class='nav-item'>
                <a class='nav-link' href='menu.php'>Pendant</a>
            </li>
            <li class='nav-item'>
                <a class='nav-link' href='add_menu.php'>&nbsp;Add Pendants</a>
            </li>
			<!-- Dropdown -->
            <li class='nav-item dropdown nav navbar-nav navbar-right'>
                <a class='nav-link' href='edit_menu.php' id='navbardrop' data-toggle='dropdown'>Edit Pendant</a>
			...
			<li class='nav-item'>
                <a class='nav-link' href='rem_menu.php'>Remove Pendants</a>
            </li>
			<li class='nav-item'>
